...
Author models in PyTorch. Compile to a sealed `.thx` artifact. Run on the behavioral simulator or neuromorphic hardware — same command, same transcript, same conformance contract.
