...
| Code | Name | When |
|---|---|---|
| [E0401](/errors/E0401) | `LifNotSupported` | LIF layer in artifact — AKD1500 uses bounded ReLU, not LIF |
| [E0402](/errors/E0402) | `DelaysNotSupported` | Synaptic delays in artifact — AKD1500 has no delay processing |
| [E0403](/errors/E0403) | `NonFiniteWeights` | NaN or Inf values in weight tensor — cannot quantize |
| [E0404](/errors/E0404) | `WrongTarget` | Artifact compiled for a different target |
| [E0407](/errors/E0407) | `TemporalInputNotSupported` | Input has T > 1 timesteps — AKD1500 requires T = 1 |
